        ...
        <>
            ...
            <main className="bg-[#0a0e14] min-h-screen">
                ...
                <section className="min-h-screen flex flex-col items-center justify-center px-8 py-16 relative overflow-hidden">
                    {/* Circuit lines decoration - left side */}
                    <motion.div
                        className="absolute left-0 top-1/3 w-64 opacity-25 hidden md:block"
                    ...
                    >
                        <svg viewBox="0 0 200 120" className="w-full">
                            ...
                            <motion.circle
                                cx="120" cy="25" r="4" fill="#00FFFF"
                                animate={{ opacity: [0.5, 1, 0.5] }}
                                transition={{ duration: 2, repeat: Infinity }}
                            />
                            <motion.circle
                                cx="120" cy="95" r="4" fill="#00FFFF"
                                animate={{ opacity: [0.5, 1, 0.5] }}
                    ...
                    {/* Circuit lines decoration - right side */}
                    <motion.div
                        className="absolute right-0 top-1/3 w-64 opacity-25 hidden md:block"
                        animate={{ opacity: [0.15, 0.3, 0.15] }}
                    ...
                    >
                        <svg viewBox="0 0 200 120" className="w-full">
                            ...
                            <motion.circle
                                cx="80" cy="25" r="4" fill="#00FFFF"
                                animate={{ opacity: [0.5, 1, 0.5] }}
                                transition={{ duration: 2, repeat: Infinity, delay: 0.5 }}
                            />
                            <motion.circle
                                cx="80" cy="95" r="4" fill="#00FFFF"
                                animate={{ opacity: [0.5, 1, 0.5] }}
                    ...
                    <motion.h2
                        className="text-lg md:text-xl tracking-[0.5em] text-gray-400 mb-6 font-light"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    <motion.h1
                        className="text-4xl md:text-6xl lg:text-7xl font-extrabold text-white tracking-tight text-center mb-6"
                    ...
                    <motion.p
                        className="text-sm md:text-base text-gray-500 mb-20 tracking-wide"
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                    ...
                    <motion.div
                        className="max-w-2xl w-full border-t border-gray-800 pt-10"
                        initial={{ opacity: 0, y: 20 }}
                        animate={{ opacity: 1, y: 0 }}
                ...
                <section className="min-h-screen px-6 md:px-8 py-20">
                    <div className="max-w-6xl mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 mb-6">
                            {/* Excuse Tax System - takes 3 columns */}
                            <motion.div
                                className="lg:col-span-3 bg-[#0B101A] border border-[#1E293B] rounded-xl p-6 md:p-8 hover:border-[#2a3a50] transition-colors duration-300"
                                initial={{ opacity: 0, y: 20 }}
                            ...
                            {/* Stakes Without Corruption - takes 2 columns */}
                            <motion.div
                                className="lg:col-span-2 bg-[#0B101A] border border-[#1E293B] rounded-xl p-6 md:p-8 hover:border-[#2a3a50] transition-colors duration-300"
                                initial={{ opacity: 0, y: 20 }}
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                        ...
                        {/* Bottom - Scoring graph card - full width */}
                        <motion.div
                            className="bg-[#0B101A] border border-[#1E293B] rounded-xl p-6 md:p-8 hover:border-[#2a3a50] transition-colors duration-300"
                            initial={{ opacity: 0, y: 20 }}
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                ...
                < section className="min-h-screen px-6 md:px-8 py-20" >
                    <div className="max-w-6xl mx-auto">
                        ...
                        <motion.div
                            className="bg-[#0B101A] border border-[#1E293B] rounded-xl p-8 md:p-12 hover:border-[#2a3a50] transition-colors duration-500"
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-4 items-start">
                                ...
                                <div className="lg:col-span-4">
                                    ...
                                    <div className="relative flex flex-col items-center">
                                        ...
                                        {/* Curved connector lines to Platform Fee */}
                                ...
                                {/* Right: Rule 1 with connector - 4 columns */}
                                <div className="lg:col-span-4 flex items-center justify-center relative">
                                    {/* Horizontal arrow connector from Goal Schema */}
                                    ...
                                    <motion.div
                                        className="border-2 border-blue-500/40 bg-blue-900/10 rounded-xl p-6 w-full max-w-xs shadow-[0_0_20px_-5px_rgba(59,130,246,0.2)] hover:shadow-[0_0_30px_-5px_rgba(59,130,246,0.4)] transition-shadow duration-300"
                                        animate={{
                                            boxShadow: [
                ...
                {/* ============== SECTION 4: WHAT THIS APP IS NOT + CTA ============== */}
                <section className="min-h-screen px-6 md:px-8 py-20 relative">
                    ...
                    {/* Diamond decoration - bottom right */}
