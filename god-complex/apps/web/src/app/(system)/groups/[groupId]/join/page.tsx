        ...
        return (
            <main className="min-h-screen bg-[#0a0e14] flex items-center justify-center p-6">
                <div className="max-w-md text-center border border-red-900/50 bg-red-950/10 p-8">
                    ...
                    <Link
                        href="/groups"
                        className="inline-block px-6 py-3 border border-gray-700 text-gray-400 hover:text-white font-bold tracking-[0.2em] text-xs uppercase transition-colors"
                    >
                        Back to Groups
                    </Link>
                </div>
        ...
        <main className="min-h-screen bg-[#0a0e14] flex items-center justify-center p-6">
            <div className="max-w-lg w-full">
                ...
                {joinError && (
                    <div className="border border-red-900/50 bg-red-950/20 p-4 mb-6">
                        ...
                        {hasPenaltyBlock && (
                            <Link
                                href="/penalties"
                                className="inline-block mt-4 px-4 py-2 border border-red-800 text-red-400 hover:bg-red-900/20 font-bold tracking-widest text-[10px] uppercase transition-colors"
                            >
                                View Penalties →
                            </Link>
                        )}
                ...
                <div className="flex gap-4">
                    <Link
                        href="/groups"
                        className="flex-1 py-4 border border-[#334155] text-gray-400 hover:text-white font-bold tracking-[0.2em] text-xs uppercase transition-colors text-center"
                    >
                        Cancel
                    </Link>
                    <button
