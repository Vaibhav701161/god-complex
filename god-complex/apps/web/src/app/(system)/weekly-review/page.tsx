...
export default function WeeklyReview() {
    ...
    const verdictColor = {
        ...
        UNSTABLE: "text-slate-300 border-slate-700/50 bg-slate-900/20",
        FAILED: "text-red-500 border-red-900/30 bg-red-950/5",
    };
    return (<main className="min-h-screen bg-[#0a0e14] pb-32 p-6 md:p-12 font-sans selection:bg-blue-500/20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
                    ...
                    <section className="md:col-span-4 md:col-start-2">
                        <div className="border-l border-red-900/20 pl-6 py-2 space-y-4">
                            ...
                            {metrics.pattern && (<div className="space-y-1 pt-2">
                    ...
                    <section className="md:col-span-6">
                        ...
                        <div className="border-t border-b border-gray-800/50 bg-[#0B101A]/30">
                            {dailyBreakdown.map((day, i) => (<div key={i} className="grid grid-cols-4 py-2 px-2 border-b border-gray-800/30 items-center hover:bg-[#0f1623]/50 transition-colors group">
