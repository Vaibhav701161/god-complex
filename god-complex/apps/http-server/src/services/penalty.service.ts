...
export async function assignMonthlyPenalties(tx: any, groupId: string, month: string, ranked: Array<{
    userId: string;
    rank: number;
}>) {
...
export async function getPenaltyConsequences(userId: string, groupId: string) {
